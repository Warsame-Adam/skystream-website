...
const faqData = [
  {
    ...
    answer:
      "In Amsterdam, the expected average temperature in November is 7°C. The warmest month is typically August, which averages 21°C. The coolest month is January, with temperatures averaging 1°C. The rainiest month is November, and the driest month is April.",
  },
  {
    question:
      "Can I cancel or amend my hotel reservation last minute if I need to?",
    answer:
      "You can always cancel or amend your hotel reservation if you need to, but look out for hotels in Amsterdam with free cancellation or flexible booking options if you want to protect your money. Some hotels allow you to cancel and get your money back if your plans change.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The nearest airport to Amsterdam is Amsterdam Schiphol Airport (AMS), which is 6.9 miles from the city centre. Other airports include: Rotterdam Airport, which is 34.3 miles from the city centre.",
  },
  {
    question: "What day is cheapest to stay in hotels in Amsterdam?",
    answer:
      "The cheapest day to stay in a hotel in Amsterdam typically depends on the availability and demand. Sunday is often the most affordable day.",
  },
];
