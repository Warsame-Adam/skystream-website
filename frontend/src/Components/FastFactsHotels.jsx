...
const FastFactsHotels = () => {
    ...
    return (
        <Container sx={{}}>
            <Typography sx={{fontWeight:"bold", fontSize:"28px",marginBottom:"30px"}}>
                Fast Facts
                <br />
                <span style={{fontSize:"16px", marginBottom:"15px", fontWeight:"normal",}}>Sleep easy, armed with the stuff that's good to know before you go.</span>
            </Typography>
            ...
            <Box sx={{display:"flex"}}>
                ...
                <Box sx={{flex:1}}>
                    ...
                    <Typography sx={{fontSize:"15px"}}>
                        ...
                        <br />
                        <span style={{fontWeight:"bold", fontSize:"18px"}}>3.2 million</span>
                    </Typography>
