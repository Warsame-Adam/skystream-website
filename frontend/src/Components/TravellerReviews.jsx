...
import {  Link, Input,  IconButton, Select, InputLabel, Typography, Button, Box, Container, TextField, MenuItem, Checkbox, FormControl, ListItemIcon, InputBase, Divider } from '@mui/material';
...
const CustomInput = styled(InputBase)(({ theme }) => ({
  ...
  borderRadius: 4,
  padding: '0 8px', // Minimal padding to match the compact style
  width: '100%',
  color: 'black',
  backgroundColor: '#fff',
  fontSize: '14px',
...
const TravellerReviews = () => {
  ...
  >
    <MenuItem value="all">
      <ListItemIcon>
        {selectedValue === "all" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>All travellers</Typography>
    </MenuItem>
    <MenuItem value="couple">
      <ListItemIcon>
        {selectedValue === "couple" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Couple</Typography>
    </MenuItem>
    <MenuItem value="family">
      <ListItemIcon>
        {selectedValue === "family" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Family traveller</Typography>
    </MenuItem>
    <MenuItem value="solo">
      <ListItemIcon>
        {selectedValue === "solo" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Solo traveller</Typography>
    </MenuItem>
    <MenuItem value="group">
      <ListItemIcon>
        {selectedValue === "group" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
...
<FormControl sx={{ m: 1, minWidth: 100 }}>
  ...
  >
    <MenuItem value="all">
      <ListItemIcon>
        {selectedRating === "all" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Traveller rating</Typography>
    </MenuItem>
    <MenuItem value="excellent">
      <ListItemIcon>
        {selectedRating === "Excellent" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Excellent</Typography>
    </MenuItem>
    <MenuItem value="good">
      <ListItemIcon>
        {selectedRating === "Good" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Good</Typography>
    </MenuItem>
    <MenuItem value="average">
      <ListItemIcon>
        {selectedRating === "Average" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Average</Typography>
    </MenuItem>
    <MenuItem value="below">
      <ListItemIcon>
        {selectedRating === "below" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
...
<Typography sx={{fontSize:"14px", fontWeight:"bold"}}>
  ...
  >
    <MenuItem value="recommended">
      <ListItemIcon>
        {selectedSortOption === "recommended" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Recommended</Typography>
    </MenuItem>
    <MenuItem value="rating h-l">
      <ListItemIcon>
        {selectedSortOption === "rating h-l" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Rating (high to low) </Typography>
    </MenuItem>
    <MenuItem value="rating l-h">
      <ListItemIcon>
        {selectedSortOption === "rating l-h" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
      <Typography sx={{ color: "black" }}>Rating (low to high)</Typography>
    </MenuItem>
    <MenuItem value="recent">
      <ListItemIcon>
        {selectedSortOption === "recent" ? <RadioButtonCheckedIcon /> : <RadioButtonUncheckedIcon />}
      </ListItemIcon>
  ...
  {TravellerData.map((Traveller, index) => (
    <React.Fragment key={index}>
      ...
      >
        ...
        <Box sx={{ gridColumn: '1', gridRow: '1 / span 2', justifySelf: 'start' }}>
          <Typography sx={{ fontWeight: 'bold', fontSize: '18px' }}>{Traveller.type}</Typography>
          <Typography sx={{ fontSize: '11px', color: 'grey' }}>{Traveller.reviewDate}</Typography>
        </Box>

        
        <Box sx={{ gridColumn: '2', gridRow: '1 / span 2', justifySelf: 'start' }}>
          <Typography sx={{ fontSize: '12.5px', my:2 }}>{Traveller.rating}/5</Typography>
          <Typography sx={{ fontSize: '15px', }}>{Traveller.review}</Typography>
        </Box>
      </Box>

    
      {index < TravellerData.length - 1 && (
        <Divider sx={{ my: 5, borderColor: 'grey.300', borderWidth: '0.2px' }} />
      )}
    </React.Fragment>
  ))}
</Box>
