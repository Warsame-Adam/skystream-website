...
import { AppBar, Toolbar, IconButton, Avatar, Typography, Button, Box, Container, FormControlLabel, Checkbox, Input } from '@mui/material';
...
const FlightSearchResultsNavbar = () => {
    ...
    return (
            ...
            <AppBar position="static" sx={{ backgroundColor: "#05203c", padding: "20px 200px", height: "220px", overflow: "hidden", transition: "height 0.3s ease" }}>
