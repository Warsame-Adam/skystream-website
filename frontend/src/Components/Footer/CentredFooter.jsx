...
const CentredFooter = () => {
    ...
    return (
        ...
        <Box sx={{ backgroundColor: '#002B49', color: 'white', padding: '50px', marginTop: '2rem' }}>
          <Container sx={{}} >
  ...
  <Typography variant="body2">
    United Kingdom - English (UK) • £ GBP
          ...
          <Box sx={{ flex: '1', minWidth: '150px', flex: '1', minWidth: '150px' }}>
            <Typography variant="body2" sx={{ marginBottom: '0.5rem' }}> {/* Adjust the size and add some margin */}
