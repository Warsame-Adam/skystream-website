...
const CityHotelsSearchBar = () => {
  ...
  // pull `key` out of props so it doesn't get spread onto the DOM
  ...
  return (
    <li
      key={key}        // pass key here
      {...rest}        // spread everything else (onClick, role, etc.)
      id={option._id}  // your own id
      style={{
        display: "flex",
    ...
    >
      ...
      readOnly: true,
      // <-- your custom styling belongs here:
      sx: {
        ...inputStyle,
        border: 0,
      },
